...
public class RssResponder implements SecureResponder {
  ...
  static class RssFeed {
    ...
    private static void makeNodes(Document rssDocument, Element itemElement, Map<String, String> itemProperties) {
  ...
  static class LinkPrefixBuilder {
    ...
    public void buildLink(Document rssDocument, Element itemElement, String pageName) throws Exception {
