...
public abstract class TestSystemBase implements TestSystem, TestSystemListener {
  ...
  public TestSystemBase(WikiPage page, TestSystemListener testSystemListener) {
    this.page = page;
