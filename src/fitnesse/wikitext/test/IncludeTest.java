...
public class IncludeTest {
    ...
    @Test public void translatesSetup() throws Exception {
        String result = ParserTestHelper.translateTo(makeIncludingPage());
    ...
    @Test public void translatesSetupWithoutCollapse() throws Exception {
        String result = ParserTestHelper.translateTo(makeIncludingPage(), new TestVariableSource("COLLAPSE_SETUP", "false"));
