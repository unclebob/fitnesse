...
Wysiwyg.prototype.insertImage = function () {
    var href = window.prompt('Provide link address');
    if (href) {
        this.execCommand("insertimage", href);
        this.selectionChanged();
    }
};
