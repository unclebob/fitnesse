...
public class HtmlUtil {
	...
	public static HtmlTag makeActionLink(String action, String name,
			String inputName, String accessKey, boolean newWindow) {
	...
	public static HtmlTag makeBreadCrumbsWithCurrentPageNotLinked(String path,
			String separator) throws Exception {
		TagGroup tagGroup = new TagGroup();
		String[] crumbs = path.split("[" + separator + "]");
	...
	public static HtmlTag makeBreadCrumbsWithPageType(String trail,
			String separator, String type) throws Exception {
	...
	private static String makeAllButLastCrumb(String[] crumbs,
	...
	public static HtmlTag makeActions(PageData pageData, String localPageName,
		...
		if (pageData.hasAttribute("RecentChanges")) {
			actions.add(makeActionLink("/RecentChanges", "Recent Changes",
					null, "", NO_NEW_WINDOW));
			actions.add(makeNavBreak());
		}
		actions.add(makeActionLink(".FitNesse.UserGuide", "User Guide",
				null, "", NO_NEW_WINDOW));
		return actions;
	}
	...
	public static String getHtmlOfInheritedPage(String pageName,
			WikiPage context) throws Exception {
		return getLabeledHtmlOfInheritedPage(pageName, context, "");
	}

	public static String getLabeledHtmlOfInheritedPage(String pageName,
			WikiPage context, String label) throws Exception {
