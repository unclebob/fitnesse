...
namespace fit
{
	...
	public class FitServerTest
	{
		...
		{
			Assert.AreEqual("0000000009", FitServer.EncodeInteger(9));
			Assert.AreEqual("0000000123", FitServer.EncodeInteger(123));
			Assert.AreEqual("0000004444", FitServer.EncodeInteger(4444));
		}
